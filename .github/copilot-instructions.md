...
- **Where to change behavior**: modify or add filters to the main plugin file. If adding classes or more complex logic, prefer placing them under `src/` and update `composer.json` with an `autoload` section (currently absent).
